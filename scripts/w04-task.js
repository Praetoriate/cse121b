...
let myProfile = {
    name: "Beau Travis",
    photo: "images\\me.jpg",
    favoriteFoods: ['Peaches and Cream','Ribeye','Sushi','Raspberry Almond Cake','Roasted Parsnips'],
    hobbies: ['Tinkering','Watching shows','PC gaming','Board gaming','Camping','4 wheeling'],
    placesLived: []
};
